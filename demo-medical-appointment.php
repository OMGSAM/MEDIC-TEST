...
<a href="demo-medical-appointment.php" class="btn btn-small btn-switch-text btn-base-color left-icon btn-round-edge btn-box-shadow">
<span>
    ...
    if ($name !== "" && $email !== "" && $date !== "" && $age !== "" && $numero !== "" && $doctor !== "") {
        ...
        if ($stmt->execute()) {
            ...
            <script>
                Swal.fire({
                    icon: 'success',
                    title: 'RECORD INSERTED SUCCESFULY',
                    text: 'Coordonnnees  valides!',
                    confiramtaionButtonText: 'Ok',
                    timer : 3500
                })
...
<span class="text-dark-gray fw-500 fs-18 w-70 xl-w-80 lg-w-100 d-block">Please feel free to contact our friendly reception staff with any medical enquiry or call <a href="tel:12345678910" class="text-decoration-line-bottom fw-700 text-dark-gray">06 61 54 64 63</a></span>
</div>
...
<span class="btn-double-text" data-text="+1 234 567 8910">06 61 43 52 62 </span>
</span>
</a>
</div>
</div>
